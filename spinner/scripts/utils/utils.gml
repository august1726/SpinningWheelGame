...
function draw_how_to_play(_x1 = room_width/30, _y1 = room_height/12, _x2 = room_width - _x1, _y2 = room_height - _y1) {
	...
	draw_text_ext_color(room_width/2, room_height/8, "Simple how to play:", 20, _x2-_x1, c_fuchsia, c_fuchsia, c_fuchsia, c_fuchsia, 1);
	draw_set_font(fnt_default)
	draw_text_ext_color(room_width/2, room_height/2, howto_text, 20, _x2-_x1, c_purple, c_purple, c_purple, c_purple, 1);
}